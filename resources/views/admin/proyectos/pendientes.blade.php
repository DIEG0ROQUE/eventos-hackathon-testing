        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Revisa y aprueba proyectos para que puedan ser evaluados por los
                            jueces</p>
                    </div>
            ...
            <div class="mb-6 bg-purple-50 border-l-4 border-purple-500 p-4 rounded-lg">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-purple-900 font-bold">{{ $proyectos->count() }} proyectos esperando aprobación
                        </p>
            ...
            @forelse($proyectos as $proyecto)
                    ...
                    <div class="p-6">
                        <div class="flex items-start justify-between mb-4">
                            ...
                            <div class="text-center ml-6">
                                <div class="text-5xl font-bold text-purple-600">{{ $proyecto->porcentaje_completado }}%
                                </div>
                        ...
                        <div class="grid grid-cols-4 gap-4 mb-4 p-4 bg-gray-50 rounded-lg">
                            <div class="text-center">
                                <p class="text-2xl font-bold text-indigo-600">
                                    {{ $proyecto->equipo->participantes->count() }}</p>
                            ...
                            <div class="text-center">
                                <p class="text-2xl font-bold text-green-600">
                                    {{ $proyecto->tareas->where('estado', 'completada')->count() }}</p>
                                ...
                                @php
                                    $porcentajeTareas =
                                        $proyecto->tareas->count() > 0
                                            ? round(
                                                ($proyecto->tareas->where('estado', 'completada')->count() /
                ...
                <div id="modalRechazar{{ $proyecto->id }}"
                    ...
                    <div class="bg-white rounded-xl shadow-xl p-6 max-w-md w-full mx-4">
                        ...
                        <form action="{{ route('admin.proyectos.rechazar', $proyecto) }}" method="POST">
                            ...
                            <div class="mb-4">
                                <label class="block text-sm font-medium text-gray-700 mb-2">Motivo del rechazo
                                    *</label>
                                <textarea name="motivo" rows="4" required maxlength="500"
                                ...
                                <p class="text-xs text-gray-500 mt-1">El equipo recibirá este mensaje y deberá
                                    completar lo que falta</p>
                            </div>

                            <div class="flex gap-3">
                                <button type="button" onclick="toggleModalRechazar('{{ $proyecto->id }}')"
