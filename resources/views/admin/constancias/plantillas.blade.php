        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-6">
                        <div class="mb-6">
                            <h4 class="font-semibold text-gray-900 mb-3">Variables disponibles:</h4>
                            <div class="space-y-2">
                                <div class="flex items-center gap-2 text-sm">
                                    <code
                                        class="px-2 py-1 bg-gray-100 rounded text-gray-800 font-mono">{recipientNombre}</code>
                                    <span class="text-gray-600">Nombre del participante</span>
                                </div>
                                <div class="flex items-center gap-2 text-sm">
                                    <code
                                        class="px-2 py-1 bg-gray-100 rounded text-gray-800 font-mono">{eventoNombre}</code>
                                    <span class="text-gray-600">Nombre del evento</span>
                                </div>
                                <div class="flex items-center gap-2 text-sm">
                                    <code
                                        class="px-2 py-1 bg-gray-100 rounded text-gray-800 font-mono">{equipoNombre}</code>
                                    <span class="text-gray-600">Nombre del equipo</span>
                                </div>
                                <div class="flex items-center gap-2 text-sm">
                                    <code
                                        class="px-2 py-1 bg-gray-100 rounded text-gray-800 font-mono">{proyectoNombre}</code>
                                    <span class="text-gray-600">Nombre del proyecto</span>
                                </div>
                                <div class="flex items-center gap-2 text-sm">
                                    <code
                                        class="px-2 py-1 bg-gray-100 rounded text-gray-800 font-mono">{codigoVerificacion}</code>
                                    <span class="text-gray-600">Código único</span>
                                </div>
                            </div>
                        </div>
                    </div>
