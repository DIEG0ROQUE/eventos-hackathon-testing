        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <form action="{{ route('admin.constancias.generar-individual') }}" method="POST" class="p-6">
                    ...
                    <div class="space-y-5">
                        <div>
                            ...
                            <input type="text" name="participante_nombre" placeholder="Nombre del destinatario"
                                required
                        ...
                        <div>
                            ...
                            <input type="email" name="participante_email" placeholder="correo@tecnm.mx" required
                            ...
                            <select name="evento_id" required
                                ...
                                @foreach ($eventos as $evento)
                                    <option value="{{ $evento->id }}">{{ $evento->nombre }} -
                                        {{ $evento->fecha_inicio->format('Y') }}</option>
                                @endforeach
                            </select>
                            @error('evento_id')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div>
                            ...
                            <textarea name="notas" rows="3" placeholder="Información adicional para incluir en la constancia..."
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                ...
                <div class="p-6 border-b border-gray-100">
                    ...
                    <p class="text-sm text-gray-600 mt-1">Genera constancias automáticamente para todos los
                        participantes de un evento</p>
                </div>
                        ...
                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                            <div class="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-blue-700 mt-1">Se generarán constancias solo para
                                        participantes que no tengan ya una constancia del tipo seleccionado para este
                                        evento.</p>
                                </div>
                            </div>
                        </div>
